...
```{r create keyring, eval = F, echo = T}
...
```{r authenticate plain, eval = F, echo = T}
...
```{r authenticate keyring, eval = F, echo = T}
yt_oauth(app_id = "my_app_id",  # paste your app ID here
