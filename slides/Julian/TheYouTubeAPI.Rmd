...
- Data on YT server is stored in a database (SQL, NoSQL, MongoDB etc.)

- The Youtube Website is build in HTML (Hyper Text Markup Language), uses CSS (Cascasind Style Sheets)
 for the "styling" and dynamically loads content using Ajax/JavaScript from the Database
...
- In general, there are 2 ways of getting data from a Website (=Webscraping)

- First way: Screenscraping = Getting the HTML-code out of your browser, parsing & formatting it,
  then analyzing the data
  
- Second way: API-harvesting = Sending requests directly to the database and only getting back the
  information that you want and that you need.
...
- Advantages of Screenscraping:
  ...
  + (Theoretically) Independent from new incoming API-restrictions
  
- Disadvantages of Screenscraping:
  - Extremely tedious to get information out of HTML-pages (They can't be parse with
    regex, you need an XML-parser)
  - You have to manually look up the Xpaths/CSS/HTML containers to identify
  ...
  - If the website changes anything
